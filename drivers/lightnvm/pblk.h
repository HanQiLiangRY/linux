...
/* Current version*/
#define PBLK_LINE_CURRENT_VER PBLK_LINE_VER(0, 2)
...
struct pblk {
	...
	int over_prov;     /* Percentage of device used for over-provisioning */
	int over_prov_blks;/* Number of blocks used for over-provisioning */
