				  ...
				  struct pblk_line *cur)
{
	...
	smeta_buf->header.version[1] = SMETA_VERSION_MAJOR;
	smeta_buf->header.version[0] = SMETA_VERSION_MINOR;
	...
	emeta_buf->header.version[1] = EMETA_VERSION_MAJOR;
	emeta_buf->header.version[0] = EMETA_VERSION_MINOR;
